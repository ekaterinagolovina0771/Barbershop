...
JAZZMIN_SETTINGS = {
    "site_title": "Панель управления Стальная борода",
    "site_header": "Стальная борода",
    "site_brand": "Стальная борода",
    "welcome_sign": "Добро пожаловать в панель управления барбершопом Стальная борода",
    "copyright": "Steel beard Barber Shop Ltd.",
