# Generated by Django 5.2.5 on 2025-08-24 06:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('not_approved', 'Новая'), ('approved', 'Подтверждена'), ('canceled', 'Отменена'), ('completed', 'Завершена')], default='not_approved', max_length=50, verbose_name='Статус')),
